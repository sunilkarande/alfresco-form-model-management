            ...
            <div id="${id}-searchmenu_more" class="yuimenu yui-overlay yui-overlay-hidden">
               <div class="bd">
                  <ul class="first-of-type">
                     <li><a style="background-image: url(${url.context}/res/components/images/header/advanced-search.png)" title="${msg("header.advanced-search.description")}" href="${siteURL("fmSearch")}">${msg("header.advanced-search.label")}</a></li>
                  </ul>
               </div>
            </div>
         </span>
