...
var modelNode = companyhome.childByNamePath('Data Dictionary/Models/JsonModels/' +jsonFileName);
var xmlNode = companyhome.childByNamePath('Data Dictionary/Models/' +args.modelName);
...
if(modelNode){
	...
	var newNode = companyhome.childByNamePath('Data Dictionary/Models/JsonModels/').createFile(jsonFileName);
	...
	if(newNode){
		...
		newJson.types = replaceObjectForArray(newJson.types['type'], newJson.types); 
